describe('$mdGesture', function() {
  ...
  function setupGesture(name, factory) {
    module('material.core', function($mdGestureProvider) {
      $mdGestureProvider.addHandler(name, factory);
    });
  }
  ...
  describe('custom gesture', function() {
    ...
    beforeEach(function() {
      ...
      setupGesture('gesture1', function() {
        return {
          onStart: startSpy1,
          onMove: moveSpy1,
          onEnd: endSpy1
      ...
      setupGesture('gesture2', function() {
        return {
          onStart: startSpy2,
          onMove: moveSpy2,
          onEnd: endSpy2
    ...
    it('should pass provided options', inject(function($document) {
